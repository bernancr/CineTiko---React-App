...
const Login = () => {
  ...
  return (
    <div className='col-10 col-lg-3 col-md-6 m-auto mt-5 d-flex flex-wrap align-items-center'>
      ...
      <h2 className="col-lg-12 text-center">Iniciar Sesión</h2>
      <p className="col-lg-12 text-center"><strong>User: </strong>admin@admin.com</p>
      <p className="col-lg-12 text-center"><strong>Pass: </strong>administrator</p>
